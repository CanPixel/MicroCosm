        ...
        <div style={style} className="absolute">
            ...
            <div style={animationStyle} className="w-full h-full">
                <svg width={size} height={size} viewBox="0 0 60 60" style={{ overflow: 'visible' }} filter="url(#mc-bloom)">
                    {/* Nuclear envelope */}
                    <circle cx="30" cy="30" r="28" fill="hsl(263 60% 30% / 0.55)" stroke="hsl(263 85% 65%)" strokeWidth="2.5" />
                    ...
                    {/* Chromatin squiggle */}
                    <path d="M 25,30 C 20,20 40,20 35,30 S 20,40 30,40 S 40,25 35,22" fill="none" stroke="hsl(198 93% 72%)" strokeWidth="2" strokeLinecap="round"/>

                    {/* Ribosome dots */}
                    <circle cx="20" cy="22" r="1.8" fill="hsl(45 100% 65%)" />
                    <circle cx="42" cy="35" r="2.2" fill="hsl(45 100% 65%)" />
                    <circle cx="38" cy="18" r="1.4" fill="hsl(45 100% 65%)" />
                </svg>
            </div>
        </div>
    );
